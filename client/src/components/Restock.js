    ...
    <div className="products">
      <div className="sidenav">
        <div className="box-links">
          ...
          <a href="/restock" className="box-container box-selected">
            <div className="box-content">
              <i class="fas fa-file-invoice-dollar nav-icon icon-selected"></i>
              Restock
            </div>
          </a>
        </div>
        ...
        <div className="nav">
          <div className="nav-content">
            <div className="section-remainder">
              <i class="fas fa-file-invoice-dollar main-icon"></i>Restock
            </div>
            ...
            <div className="table">
              {products.length > 0 ? (
                ...
                <div className="info-text">
                  There is nothing around here. To see restock registers, you
                  have to sell a product in the products section, or reduce the
                  quantity of a product in the same section.
                </div>
              ) : null}
